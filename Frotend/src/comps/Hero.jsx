    ...
    return (
        <div className={`relative ${props.heig ? "h-[500px]" : "h-screen"}`}>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                ...
                <p className="text-xl md:text-2xl mb-8 text-center">{props.text ? props.text : "We empower young women in Africa with tech, education, and mentorship, building a future of equal opportunities for all girls to lead and succeed"}</p>
